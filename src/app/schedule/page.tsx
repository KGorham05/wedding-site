    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-12 bg-gradient-to-r from-gray-50 to-slate-50 rounded-2xl p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="lg:w-2/3">
                <h2 className="text-3xl font-serif text-gray-800 mb-2">
                  Saturday, August 23rd
                ...
                <div className="bg-blue-50 rounded-lg p-4 mb-4">
                  <h4 className="font-semibold text-blue-800 mb-2">🤠 Optional Add-On: Custom Cowboy Hat Making</h4>
              ...
              <div className="lg:w-1/3 lg:pl-8 mt-6 lg:mt-0">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h4 className="font-semibold text-gray-800 mb-4">Custom Hat Making</h4>
