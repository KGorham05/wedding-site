...
export default function AdventureDay3() {
  ...
  const handleContinue = () => {
    ...
    saveRSVPPage(updatedData as unknown as GuestData, 'day-3');
        ...
        <div className="max-w-4xl mx-auto pb-20">
          <div className="surface-glass-1 rounded-2xl p-8 shadow-2xl mb-8 border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4 items-stretch pt-6">
              <Link href="/adventure/day-2" className="btn-glass text-white py-2 px-4 rounded-lg transition-all duration-300 focus-ring text-center">
                ← Back to Day 2
              </Link>
              <button
