    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link href="/our-story" className="text-gray-900 font-medium">
                Our Story
              </Link>
      ...
      <div className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-4xl font-serif text-gray-800 mb-8">Our Story</h1>
          <p className="text-lg text-gray-600">
            Coming soon... Angela will provide the details of how they met, their proposal story, and more!
          </p>
          <div className="mt-8">
            <Link 
              href="/" 
