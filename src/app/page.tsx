    ...
    <div className="min-h-screen bg-white">
      ...
      <OptimizedHeroVideo>
        <div className="text-center px-4 sm:px-6">
          ...
          <Link 
            href="/rsvp"
            className="inline-block bg-sage-600 text-white px-8 py-3 rounded-full font-medium text-lg hover:bg-sage-700 transition-colors shadow-lg"
          >
            RSVP Now
          </Link>
        </div>
      ...
      <section className="py-16 bg-cream-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-serif text-warm-gray-800 mb-4">
          ...
          <div className="grid gap-6 md:gap-8">
            ...
            <div className="bg-sage-50 rounded-lg p-6 border border-sage-200">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-warm-gray-500">6:00 PM - 9:00 PM</p>
                </div>
              </div>
            </div>
            ...
            {/* August 21st */}
            <div className="bg-dusty-rose-50 rounded-lg p-6 border border-dusty-rose-200">
              <div>
                <h3 className="text-xl font-semibold text-dusty-rose-800 mb-2">
            ...
            {/* August 22nd */}
            <div className="bg-sage-100 rounded-lg p-6 border border-sage-200">
              <div>
                <h3 className="text-xl font-semibold text-sage-800 mb-2">
            ...
            {/* August 23rd */}
            <div className="bg-warm-gray-100 rounded-lg p-6 border border-warm-gray-200">
              <div>
          ...
          <div className="text-center mt-8">
            <Link 
              href="/schedule"
              className="inline-block bg-sage-600 text-white px-6 py-3 rounded-full font-medium hover:bg-sage-700 transition-colors"
            >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center">
            <Link 
              href="/our-story"
              className="inline-block bg-dusty-rose-600 text-white px-6 py-3 rounded-full font-medium hover:bg-dusty-rose-700 transition-colors"
            >
              Read Our Story
            </Link>
          </div>
      ...
      <section className="py-16 bg-cream-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Ceremony */}
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-warm-gray-800 mb-4">Ceremony & Reception</h3>
              <p className="text-warm-gray-600 mb-2">Sanctuary at Crow Hollow Ranch</p>
              <p className="text-warm-gray-600 mb-4">187 Suce Creek Rd, Livingston, MT 59047</p>
            ...
            {/* Travel */}
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-warm-gray-800 mb-4">Travel Information</h3>
              <p className="text-warm-gray-600 mb-2">Nearest Airport: Bozeman, MT</p>
              <p className="text-warm-gray-600 mb-4">45 minutes from venue</p>
              <p className="text-sm text-warm-gray-500 mb-4">
